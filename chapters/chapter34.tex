...
Luận văn này được thực hiện dựa trên nền tảng robot di động EAI Dashgo D1. Trong \figurename{ \ref{fig:dashgoD1}} là một nền tảng robot di động thông minh được sản xuất phục vụ nghiên cứu về robot tự hành và Hình \ref{fig:airhustbot} là robot đang trong quá trình phát triển thành robot dịch vụ thông minh.
...
\begin{figure}[htbp]
    \centering
    \subfloat[]{\includegraphics[width=0.45\linewidth]{figures/RB_mapping.png}}
    \subfloat[]{\includegraphics[width=0.45\linewidth]{figures/RB_mapping02.png}}
...
%  Có 7 cảm biến ở phía trước robot và 3 cảm biến ở phía sau robot.
...
Chúng ta sẽ sử dụng \codeword{cmd_vel_mux} của \codeword{nodelet} để thực hiện phân quyền điều khiển cho robot để dễ dàng tích hợp tín hiệu điều khiển từ cảm biến an toàn IR (Hình \ref{fig:phanquen-dexuat})
...
Sau quá trình nghiên cứu và làm việc dưới sự hướng dẫn của TS. Nguyễn Xuân Hạ, tác giả đã có một số kết quả như sau:
\begin{itemize}
...
\begin{table}[htbp]
    \begin{tabular}{|m{1.5cm}|m{1.2cm}|m{1.2cm}|m{1.2cm}|m{1.2cm}|m{1.2cm}|m{1.2cm}|m{1.2cm}|m{1.2cm}|}
        \hline
...
\begin{figure}[htbp]
    \centering
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_withIR_ObstacleDetected.png}}
    \hspace{8pt}
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_withIR_navigation.png}}
