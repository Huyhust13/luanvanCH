...
\begin{figure}[htbp]
    \centering
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_bb_detect_obstacle.jpg}}
    \hspace{8pt}
    \subfloat[]{\includegraphics[width=0.45\linewidth]{figures/RB_bb_detect_obstacle_reAct.jpg}}
    \qquad
    \subfloat[]{\includegraphics[width=0.45\linewidth]{figures/RB_bb_detect_obstacle_avoided.jpg}}
