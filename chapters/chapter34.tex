...
\begin{figure}[htbp]
    ...
    \hspace{8pt}
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_bb_detect_obstacle_reAct.jpg}}
    % \qquad
    \hspace{8pt}
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_bb_detect_obstacle_avoided.jpg}}
