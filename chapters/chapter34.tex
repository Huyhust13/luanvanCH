...
\subfloat[][]{
    ...
    \caption[Sai số tương ứng với N lần lấy mẫu]{Sai số tương ứng với N lần lấy mẫu. Trục hoành thể hiện giá trị thực tế cần đo, trục tung thể hiện giá trị đo được trung bình}
...
\begin{figure}[htbp]
    \centering
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_navi_without_IR.jpg}}
    \hspace{8pt}
    \subfloat[]{\includegraphics[width=0.75\linewidth]{figures/RB_navi_with_IR.jpg}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[]{\includegraphics[width=0.6\linewidth]{figures/RB_bb_detect_obstacle.jpg}}
    \hspace{8pt}
    \subfloat[]{\includegraphics[width=0.6\linewidth]{figures/RB_bb_detect_obstacle_reAct.jpg}}
    % \qquad
    \hspace{8pt}
