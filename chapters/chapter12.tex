...
Trong đó, ${x}_{t}$ là trạng thái vị trí tại thời điểm $t$, $m$ là bản đồ, và ${z}_{1:t}$ và ${u}_{1:t}$ là các giá trị đo và điều khiển tương ứng. Vấn đề này gọi là SLAM online vì nó chỉ bao gàm sự dự đoán của các biến tại thời điểm $t$. Có nhiều giải thuật cho vấn đề online SLAM: chúng bỏ qua các dữ liệu đo và điều khiển cũ một khi chúng đã được xử lý. Mô hình online SLAM được thể hiện như trong \figurename{\ref{fig:onlineSLAM}
